...
public class MaintenanceHydrantActivity extends AppCompatActivity {

    UserPreferences userPreferences;
    RecyclerView recyclerView;
    Spinner spinnerruang, spinnerfungsi;
    EditText ettekanan;
    String barcode, ruang, fungsi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maintenance_hydrant);
        ...
        spinnerruang = findViewById(R.id.detailruanghydrant);
        spinnerfungsi = findViewById(R.id.detailfungsihydrant);
        ettekanan = findViewById(R.id.detailtekananhydrant);
        tvjamdigital = findViewById(R.id.tanggalsekaranghydrant);
        recyclerView = findViewById(R.id.recycletabel);
        tombolkembali = findViewById(R.id.backhomehydrant);
        linear = findViewById(R.id.linear);
        Button submithydrant = findViewById(R.id.submithydrant);
        blink();
        getLokasi();
        ...
        spinnerfungsi.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                fungsi = parent.getItemAtPosition(position).toString();
            }
        ...
        submithydrant.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                String catatan = ((EditText) findViewById(R.id.textboxhydrant)).getText().toString();
                String waktu = tvjamdigital.getText().toString();
                postData(waktu, barcode_ac, user, lokasi, catatan, tekanan, fungsi);
            }
        });
            ...
            public void onResponse(Call<LokasiResponse> call, Response<LokasiResponse> response) {
                if (response.isSuccessful()) {
                    if (response.body().getData() != null) {
                        ...
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(MaintenanceHydrantActivity.this, android.R.layout.simple_spinner_item, listlokasi);
    ...
    private void postData(String waktu_maintenance, String barcode, String username, String lokasi, String catatan, String tekanan, String fungsi) {
        Call<InputData> client = ApiClient.getApiService().inputDataHydrant(waktu_maintenance, barcode, username, lokasi, catatan, tekanan, fungsi);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(MaintenanceHydrantActivity.this, HomeActivity.class);
